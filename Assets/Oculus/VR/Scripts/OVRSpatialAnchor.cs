...
public class OVRSpatialAnchor : MonoBehaviour
{
	...
	{
		Storage = OVRPlugin.SpaceStorageLocation.Local,
	};
    ...
    {
	    var erased = OVRPlugin.EraseSpace(Space, eraseOptions.Storage, out var requestId);
...
#pragma warning restore CS0618
	...
	public struct EraseOptions
	{
		...
		/// </summary>
		public OVRPlugin.SpaceStorageLocation Storage;
	}
